...
public final class ChunkColoredLightSampler {
    ...
    private static final ColoredLightValue[] EMPTY = Util
            .make(new ColoredLightValue[OCTANT_COUNT * OCTANT_COUNT * OCTANT_COUNT], points -> Arrays.fill(points, ColoredLightValue.NO));
    ...
    private static void addLightSourceSamples(ColoredLightValue[] samples, int lightBlockX, int lightBlockY, int lightBlockZ, int luminance, float red, float green, float blue) {
